...
def main():
    ...
    if FLAGS.job_name == "ps":
        ...
        with tf.device(tf.train.replica_device_setter(worker_device="/job:worker/task:%d" % FLAGS.task_index, cluster=cluster)):
            ...
            y_predict, mean_loss, train, global_step = DNN_model(x, y_actual, feature_length, [15, 10, 5], keep_prob, 0.001)
            ...
            with tf.train.MonitoredTrainingSession(server.target,
                ...
                while not sess.should_stop():
                    ...
                    if (step % 50 == 0):
                        # 训练样本
                        print("step = ", step, "train_auc_value=", train_auc_value, "train_mean_loss=", train_mean_loss, end=" ")
                        # 测试样本
